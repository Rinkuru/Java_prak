...
На этапе проектирования нужно описать use cases, страницы приложения, их содержимое и схему навигации между ними.
...
## 3. Описание сценариев использования

### Люди и резюме

#### UC-01. Просмотреть список людей
...
#### UC-02. Открыть карточку человека
...
#### UC-03. Добавить нового человека
...
#### UC-04. Отредактировать данные человека
...
#### UC-06. Просмотреть историю работы человека
**Страницы:** P-03 "Карточка человека"
...
#### UC-07. Добавить запись в историю работы
...
#### UC-08. Отредактировать запись о месте работы
**Страницы:** P-03 "Карточка человека" → P-05 "Форма редактирования информации о работе"
...
#### UC-09. Удалить запись из истории работы
**Страницы:** P-03 "Карточка человека" → P-05 "Форма редактирования информации о работе"
...
#### UC-10. Просмотреть список компаний
...
#### UC-11. Открыть карточку компании
...
#### UC-13. Отредактировать данные компании
...
#### UC-15. Просмотреть список вакансий компании
**Страницы:** P-07 "Карточка компании"
...
#### UC-16. Добавить вакансию в компанию
...
#### UC-17. Отредактировать вакансию
...
#### UC-19. Просмотреть подробности вакансии
...
#### UC-20. Закрыть вакансию без удаления
**Страницы:** P-09 "Карточка вакансии"
...
#### UC-21. Переоткрыть ранее закрытую вакансию
**Страницы:** P-09 "Карточка вакансии"
...
#### UC-22. Показывать в поиске только активные вакансии
...
#### UC-23. Найти резюме по образованию
...
#### UC-24. Найти резюме по зарплате
**Страницы:** P-02 "Список людей"
...
#### UC-25. Найти резюме по компаниям, в которых человек работал
**Страницы:** P-02 "Список людей"
...
#### UC-26. Найти резюме по должностям, которые человек занимал
**Страницы:** P-02 "Список людей"
...
#### UC-27. Найти вакансии по компании
**Страницы:** P-06 "Список компаний" / P-07 "Карточка компании"
...
#### UC-28. Найти вакансии по должности
...
#### UC-29. Найти вакансии по зарплате
**Страницы:** P-06 "Список компаний" / P-07 "Карточка компании"
...
#### UC-30. Применить несколько фильтров к списку резюме
**Страницы:** P-02 "Список людей"
...
#### UC-31. Применить несколько фильтров к списку вакансий
**Страницы:** P-06 "Список компаний" / P-07 "Карточка компании"
...
#### UC-32. Отсортировать результаты по зарплате
...
#### UC-33. Скрывать из подбора людей, которые не ищут работу
...
#### UC-34. Скрывать закрытые вакансии
...
#### UC-35. Найти подходящие вакансии для выбранного человека
...
#### UC-36. Найти подходящие резюме для выбранной вакансии
...
#### UC-37. Отсортировать список совпадений
**Страницы:** P-11 "Результаты подбора"
...
#### UC-38. Проверить обязательные поля вакансии
...
#### UC-39. Проверить обязательные поля человека
...
#### UC-40. Проверить отсутствие пересечений дат в истории работы
...
### P-05. Форма редактирования информации о работе
**Содержимое:**
- Поля: компания, должность, зарплата, дата начала, дата окончания, признак текущего места работы.
- Сообщения об ошибках валидации.
...
## 6. Отображение данных БД на страницы пользовательского интерфейса
...
## 7. Схема навигации между страницами
...
## 8. Проверки корректности данных
...
|---|---|---|
| `person` | `status` | Признак поиска работы: `TRUE` означает, что человек ищет работу, `FALSE` — не ищет. |
